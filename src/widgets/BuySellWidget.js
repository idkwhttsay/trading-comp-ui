  ...
  return (
    <div>
      ...
      <div className="button-container">
        <button className="button buy" onClick={(event) => handleBuySellClick(event, 'buy')}>
          Buy
        </button>
        <button className="button sell" onClick={(event) => handleBuySellClick(event, 'sell')}>
          Sell
        </button>
      </div>
      {isModalOpen && (
              ...
              {modalContent === 'buy' ? (
                ...
                <div className="sell-section">
                  ...
                  <span className="price-span">
                    Owned: {samplePnLData.find((stock) => stock.ticker === selectedStock).quantity}
                  </span>
                  {/* Quantity Type Toggle Buttons */}
                  <div className="order-type-toggle">
                    <button
                  ...
                  <div className="quantity-input-container">
                    ...
                    <input
                      ...
                      max={
                        quantityType === 'shares'
                          ? samplePnLData.find((stock) => stock.ticker === selectedStock).quantity
                          : samplePnLData.find((stock) => stock.ticker === selectedStock).quantity *
                            price
                      }
                      onChange={(e) => setQuantity(e.target.value)}
                  ...
                  {quantityType === 'shares' && (
                    <div>
                      <span>
                        Estimated Value: $
                        {orderType === 'limit' ? quantity * limitPrice : quantity * stock.price}
                      </span>
                    </div>
                  )}
                  {quantityType === 'dollars' && (
